...
const Hero = () => {
    return (
        ...
        <div className="w-full pt-10 md:pt-5 mt-10 md:mt-0">
            <div className="relative flex flex-col gap-10 md:gap-0 md:flex-row justify-between items-center pt-10">
                ...
                <Image src="/header3.jpeg" className="absolute  -z-10 opacity-45 top-1/3 rounded-xl md:rounded-br-full md:rounded-tl-full md:relative md:opacity-100 " alt="hero" width={1000} height={1000} />
            </div>
